...
默认情况下，Fly 会分配公共 IP，使您的网关可通过 `https://your-app.fly.dev` 访问。这很方便，但也意味着您的部署可能被互联网扫描器（Shodan、Censys 等）发现。

对于**完全无公开暴露**的加固部署，请使用私有模板。

...
在 Oracle Cloud 的“始终免费”ARM层上运行一个持久的 OpenClaw 网关。
...
- Oracle Cloud账户（[注册](https://www.oracle.com/cloud/free/)）——如遇问题，请参阅 [社区注册指南](https://gist.github.com/rssnyder/51e3cfedd730e7dd5f4a816143b25dbd)
- Tailscale账户（免费，访问 [tailscale.com](https://tailscale.com)）
- 大约30分钟
...
大多数 npm 包运行良好。对于二进制文件，可查找 `linux-arm64` 或 `aarch64` 发布版本。
